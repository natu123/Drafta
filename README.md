...
- **Organization**:
  ...
  - **Archive & Restore**: Never lose an idea; restore from verify deletion.
- **Modern UI**:
  - **Dark/Light Mode**: Seamless theme switching.
  - **Responsive Layout**: Optimized 3-pane design (Sidebar, List, Editor).
...
- **State**: React Hooks & LocalStorage (Offline capable)
