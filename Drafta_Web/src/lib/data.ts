...
export const notes: Note[] = [
  {
    ...
    .thought {
      state: brilliant;
    }</code></pre><p></p><h3><span style="color: #64A364"><em>Organize to-dos and thoughts seamlessly.</em></span></h3><ul data-type="taskList"><li data-type="taskItem" data-checked="true"><label><input type="checkbox" checked="checked"><span></span></label><div><p>Put your tasks in ToDo app, memos in note-taking app.</p></div></li><li data-type="taskItem" data-checked="false"><label><input type="checkbox"><span></span></label><div><p>Every thought in one place, Drafta!</p></div></li></ul><p></p><hr /><table><tbody><tr><th colspan="1" rowspan="1"><p>Before</p></th><th colspan="1" rowspan="1"><p><span style="color: #C49547">\u279B</span> After</p></th></tr><tr><td colspan="1" rowspan="1"><p><s>Scattered notes</s></p></td><td colspan="1" rowspan="1"><p>Structured Knowledge</p></td></tr><tr><td colspan="1" rowspan="1"><p><s>Rough thought</s></p></td><td colspan="1" rowspan="1"><p>Polished ideas</p></td></tr></tbody></table><p></p><hr /><blockquote><p>Move forward, feel lighter.</p></blockquote>`,
    plainTextContent: `Organize to-dos and thoughts seamlessly. Put your tasks in ToDo app, memos in note-taking app. Every thought in one place, Drafta! Before \u279B After Scattered notes Structured Knowledge Rough thought Polished ideas Move forward, feel lighter.`,
    group: 'inbox',
    stars: 3,
    isPinned: true,
...
console.log(drafta);</code></pre><p></p><h4>Tables</h4><table><tbody><tr><th><p>Feature</p></th><th><p>Status</p></th></tr><tr><td><p>Markdown</p></td><td><p>Done</p></td></tr><tr><td><p>Rich Text</p></td><td><p>Done</p></td></tr></tbody></table><p></p><hr /><h3>Drafta Power Tips</h3><ul><li><p><strong>List Style</strong>: Choose Top or Bottom in Settings.</p></li><li><p><strong>Organization</strong>: In Manual order, drag to reorder. On touch screens, hold first, then move.</p></li><li><p><strong>Focus Mode</strong>: Collapse the sidebar for distraction-free writing.</p></li><li><p><strong>Shortcuts</strong>: <code>/</code> to insert blocks. Type to filter, use ↑/↓ and Enter, or click. Esc closes the menu.</p></li></ul>`,
