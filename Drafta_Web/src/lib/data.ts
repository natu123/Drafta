...
console.log(drafta);</code></pre><p></p><h4>Tables</h4><table><tbody><tr><th colspan="1" rowspan="1"><p>Feature</p></th><th colspan="1" rowspan="1"><p>Status</p></th></tr><tr><td colspan="1" rowspan="1"><p>Markdown</p></td><td colspan="1" rowspan="1"><p>✅</p></td></tr><tr><td colspan="1" rowspan="1"><p>Rich Text</p></td><td colspan="1" rowspan="1"><p>✅</p></td></tr></tbody></table><p></p><hr /><h3>Drafta Power Tips</h3><ul><li><p><strong>List/Grid View</strong>: Toggle layouts from the header.</p></li><li><p><strong>Organization</strong>: Drag notes to reorder.</p></li><li><p><strong>Focus Mode</strong>: Collapse the sidebar for distraction-free writing.</p></li><li><p><strong>Shortcuts</strong>: <code>/</code> for commands (coming soon!).</p></li></ul>`,
  ...
  "user": {
    ...
    plainTextContent: `Project Goals Focus on improving user engagement and retention. Key Features 🎮 Gamification - Points, badges, streaks 💬 Community Forums - User discussions 🎯 Personalized Recommendations - AI-driven suggestions Data Structure Draft Timeline Phase Duration Status Research 2 weeks ✅ Done Design 3 weeks 🔄 In Progress Development 6 weeks ⏳ Pending Ship fast, iterate faster!`,
    group: 'work',
    stars: 1,
  ...
  },
  {
    ...
    plainTextContent: `🥛 Dairy Milk (2L) Greek Yogurt Cheddar Cheese 🍞 Bakery Whole Wheat Bread Croissants (4 pack) 🍎 Produce Apples Bananas Spinach Budget Planner Category Est. Cost Dairy $15.00 Bakery $8.50 Produce $12.00 Total $35.50`,
    group: 'personal',
    stars: 0,
